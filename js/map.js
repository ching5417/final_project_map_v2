var all_city_name = ['-請選擇-', '全部地區','臺北市','新北市','桃園市','臺中市','臺南市','高雄市',
...
var marker_data_a1;
$.getJSON('json/marker_data_a1.json', data=>{
    $("p").text("a1json");
    marker_data_a1 = data;
});
var marker_data_a2;
$.getJSON('json/marker_data_a2.json', data=>{
    $("p").text("a2json");
    marker_data_a2 = data;
});
...
function draw_map(selected_city){
    ...
    $.getJSON('json/taiwanCities.geojson.json', data=>{
        // $("p").text("fuck");
